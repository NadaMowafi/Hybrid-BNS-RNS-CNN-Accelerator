...
module tb_rns_conv2_parallel_filter0;
    ...
    initial begin
        ...
        $display("================================================");
        $display(" Fully Parallel RNS Conv2 Filter0 Full Map ");
        $display(" 196 outputs, 288 MAC terms/output ");
        $display("================================================");
        ...
        $display("----------------------------------------------");
        $display("Parallel RNS Conv2 Filter0 Performance Report");
        ...
        if (mismatch_count == 0)
            $display("ALL %0d PARALLEL RNS CONV2 FILTER0 OUTPUTS PASSED", NUM_OUTPUTS);
        else
