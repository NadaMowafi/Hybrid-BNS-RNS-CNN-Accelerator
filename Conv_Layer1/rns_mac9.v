...
module rns_mac9 (
    ...
    // ---------------- Encode bias ----------------
    bns_to_rns enc_bias (.x_in(bias), .r1(br1), .r2(br2));
    ...
    mod_add #(.M(32749), .WIDTH(16)) add1_b (.a(s8_r1), .b(br1), .y(acc_r1));
    ...
    mod_add #(.M(65521), .WIDTH(16)) add2_b (.a(s8_r2), .b(br2), .y(acc_r2));
